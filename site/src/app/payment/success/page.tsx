...
function PaymentSuccessContent() {
  ...
  useEffect(() => {
    ...
    verifyPayment();
  }, [paymentId, orderId, bookingId, router, searchParams]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link
            ...
            data-clickable-element="success-error-back"
            data-element-description="Return to booking page when payment verification fails"
          >
            Back to Booking
          </Link>
        </div>
      ...
      <div className="max-w-md mx-auto text-center">
        ...
        <div className="space-y-3 print:hidden">
          <Link
            ...
            data-clickable-element="success-book-another"
            data-element-description="Navigate to rooms page to make another booking"
          >
            Book Another Room
          </Link>
          <button
            ...
            data-clickable-element="success-print-receipt"
            data-element-description="Print booking confirmation receipt"
          >
            Print Receipt
          </button>
          <Link
            ...
            data-clickable-element="success-back-home"
            data-element-description="Navigate back to homepage after successful booking"
          >
            Back to Home
          </Link>
        </div>
